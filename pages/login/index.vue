<template>
  <div style="height: 100%">
    <div
      class="LoginWrap"
      :class="{ isRegister: RegisterVisible, isLogin: LoginVisible }"
    >
      <div class="content">
        <div class="cardWrap">
          <div
            class="card shadow Noborder CardWelcome"
          ...
          <div
            class="card shadow Noborder CardRegiste"
            :class="{ isShow: RegisterVisible }"
          >
            <div class="card-body">
              ...
              <form class="form-wrap">
                ...
                <button class="btn btnRegiste" @click="RegisterUser">
                  注册
                </button>
              </form>
            </div>
          ...
          <div
            class="card shadow Noborder CardLogin"
            :class="{ isShow: LoginVisible }"
          >
            <div class="card-body">
